...
Alternatively, you can use the go install method to compile the project using your local environment:
    ...
    go install github.com/bdandy/mockery/v2@latest
